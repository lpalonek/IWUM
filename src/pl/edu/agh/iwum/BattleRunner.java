...
public class BattleRunner {
    ...
    private static final String SOURCE_DIRECTORY_PREFIX = "out/production/IWUM/";
    ...
    public static void main(String[] args) {
        ...
        RobocodeEngine engine = new RobocodeEngine(new File("out")); // Run from C:/Robocode
...
//        BattleSpecification battleSpec = new BattleSpecification(numberOfRounds, battlefield, selectedRobots);
        BattleSpecification battleSpec = new BattleSpecification(battlefield, numberOfRounds, 50, 0.1, 50, true, robots, arr);
    ...
    public static void copyRobots() {
        try {
            ...
            Files.copy(Paths.get(SOURCE_DIRECTORY_PREFIX + PACKAGE_PATH + PIQLE_BOT),
                    Paths.get(TARGET_DIRECTORY_PREFIX + PACKAGE_PATH + PIQLE_BOT),
                    StandardCopyOption.REPLACE_EXISTING);
            Files.copy(Paths.get(SOURCE_DIRECTORY_PREFIX + PACKAGE_PATH + DUMMY_BOT),
                    Paths.get(TARGET_DIRECTORY_PREFIX + PACKAGE_PATH + DUMMY_BOT),
                    StandardCopyOption.REPLACE_EXISTING);
        } catch (IOException e) {
            e.printStackTrace();
        }
